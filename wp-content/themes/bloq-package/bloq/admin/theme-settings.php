...
$options[] = array( "name" => __('Custom logo upload','framework_localize'),
			"desc" => __('Upload a custom logo for your site.','framework_localize'),
			"id" => $shortname."_sitelogo",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Custom favicon upload','framework_localize'),
			"desc" => __('Upload a custom favicon for your site.','framework_localize'),
			"id" => $shortname."_favicon",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Custom touch icon upload','framework_localize'),
			"desc" => __('Upload a custom touch icon for your site.','framework_localize'),
			"id" => $shortname."_touch_icon",
			"std" => "",
			"type" => "upload");
				
$options[] = array( "name" => __('Email address contact form','framework_localize'),
			"desc" => "Enter the email address where you'd like to receive emails from the contact form, or leave blank to use admin email. ",
			"id" => $shortname."_recipient",
			"std" => "",
			"type" => "text");
			
$options[] = array( "name" => __('Google Maps address','framework_localize'),
			"desc" => "Insert your Google Maps address.",
			"id" => $shortname."_address",
			"std" => "",
			"type" => "textarea");
			
$options[] = array( "name" => __('Tracking code','framework_localize'),
			"desc" => "Insert your tracking code.",
			"id" => $shortname."_tracking",
			"std" => "",
			"type" => "textarea");

/* Option Page 2 - Styling options */
$options[] = array( "name" => __('Styling options','framework_localize'),
			"type" => "heading");
			
$options[] = array( "name" => __('Theme stylesheet','framework_localize'),
			"desc" => "Choose a theme stylesheet.",
			"id" => $shortname."_color",
			"std" => "",
			"type" => "select",
			"options" => $colors);
			
$options[] = array( "name" => __('Theme fonts','framework_localize'),
			"desc" => __('Select your theme font.','framework_localize'),
			"id" => $shortname."_font",
			"std" => "Helvetica",
			"type" => "select",
			"options" => $fonts);
			
$options[] = array( "name" => __('Home portfolio items','framework_localize'),
			"desc" => __('Select portfolio items displayed in home (to set as infinite type "-1").','framework_localize'),
			"id" => $shortname."_port_items",
			"std" => "8",
			"type" => "text");
			
$options[] = array( "name" => __('Contact form','framework_localize'),
			"desc" => __('Enable form in contact page.','framework_localize'),
...
/* Option Page 3 - Home Slider */				
$options[] = array( "name" => __('Home slideshow','framework_localize'),
			"type" => "heading");
			
$options[] = array( "name" => __('Alternative slideshow','framework_localize'),
			"desc" => __('Check to enable alternative slideshow.','framework_localize'),
			"id" => $shortname."_home_slideshow",
			"std" => "false",
			"type" => "checkbox");
			
$options[] = array( "name" => __('Alternative slideshow first image','framework_localize'),
			"desc" => __('Upload first image.','framework_localize'),
			"id" => $shortname."_home_slide_1",
			"std" => "",
			"type" => "upload");

$options[] = array( "name" => __('Alternative slideshow second image','framework_localize'),
			"desc" => __('Upload second image.','framework_localize'),
			"id" => $shortname."_home_slide_2",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Alternative slideshow third image','framework_localize'),
			"desc" => __('Upload third image.','framework_localize'),
			"id" => $shortname."_home_slide_3",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Alternative slideshow fourth image','framework_localize'),
			"desc" => __('Upload fourth image.','framework_localize'),
			"id" => $shortname."_home_slide_4",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Alternative slideshow fifth image','framework_localize'),
			"desc" => __('Upload fifth image.','framework_localize'),
			"id" => $shortname."_home_slide_5",
			"std" => "",
			"type" => "upload");
				
/* Option Page 4 - Portfolio Slider */				
$options[] = array( "name" => __('Portfolio slideshow','framework_localize'),
			"type" => "heading");
			
$options[] = array( "name" => __('Alternative slideshow','framework_localize'),
			"desc" => __('Check to enable alternative slideshow.','framework_localize'),
			"id" => $shortname."_port_slideshow",
			"std" => "false",
			"type" => "checkbox");
			
$options[] = array( "name" => __('Alternative slideshow first image','framework_localize'),
			"desc" => __('Upload first image.','framework_localize'),
			"id" => $shortname."_port_slide_1",
			"std" => "",
			"type" => "upload");

$options[] = array( "name" => __('Alternative slideshow second image','framework_localize'),
			"desc" => __('Upload second image.','framework_localize'),
			"id" => $shortname."_port_slide_2",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Alternative slideshow third image','framework_localize'),
			"desc" => __('Upload third image.','framework_localize'),
			"id" => $shortname."_port_slide_3",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Alternative slideshow fourth image','framework_localize'),
			"desc" => __('Upload fourth image.','framework_localize'),
			"id" => $shortname."_port_slide_4",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Alternative slideshow fifth image','framework_localize'),
			"desc" => __('Upload fifth image.','framework_localize'),
			"id" => $shortname."_port_slide_5",
			"std" => "",
			"type" => "upload");
			
/* Option Page 5 - Blog Slider */				
$options[] = array( "name" => __('Blog slideshow','framework_localize'),
			"type" => "heading");
...
$options[] = array( "name" => __('Alternative slideshow first image','framework_localize'),
			"desc" => __('Upload first image.','framework_localize'),
			"id" => $shortname."_blog_slide_1",
			"std" => "",
			"type" => "upload");

$options[] = array( "name" => __('Alternative slideshow second image','framework_localize'),
			"desc" => __('Upload second image.','framework_localize'),
			"id" => $shortname."_blog_slide_2",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Alternative slideshow third image','framework_localize'),
			"desc" => __('Upload third image.','framework_localize'),
			"id" => $shortname."_blog_slide_3",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Alternative slideshow fourth image','framework_localize'),
			"desc" => __('Upload fourth image.','framework_localize'),
			"id" => $shortname."_blog_slide_4",
			"std" => "",
			"type" => "upload");
			
$options[] = array( "name" => __('Alternative slideshow fifth image','framework_localize'),
			"desc" => __('Upload fifth image.','framework_localize'),
			"id" => $shortname."_blog_slide_5",
			"std" => "",
			"type" => "upload");
			
/* Option Page 6 - Social Options */				
$options[] = array( "name" => __('Social settings','framework_localize'),
			"type" => "heading");
			
$options[] = array( "name" => __('Behance','framework_localize'),
			"desc" => "Insert your Behance link.",
			"id" => $shortname."_behance",
			"std" => "",
			"type" => "text");
			
$options[] = array( "name" => __('Dribbble','framework_localize'),
			"desc" => "Insert your Dribbble link.",
