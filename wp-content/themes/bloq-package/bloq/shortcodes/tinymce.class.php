...
function tt_head()
	{
		// css
		wp_enqueue_style( 'themelovin-popup', GLG_TINYMCE_URI . '/css/popup.css', false, '1.0', 'all' );
		
		// js
		wp_enqueue_script('jquery-ui-sortable');
		wp_enqueue_script( 'glg-jquery-livequery', GLG_TINYMCE_URI . '/js/jquery.livequery.js', false, '1.1.1', false );
		wp_enqueue_script( 'glg-jquery-appendo', GLG_TINYMCE_URI . '/js/jquery.appendo.js', false, '1.0', false );
		wp_enqueue_script( 'glg-popup', GLG_TINYMCE_URI . '/js/popup.js', false, '1.0', false );
	}
...
/*--------------------------------------*/
	...
	{
		$plugin_array['visionShortcodes'] = GLG_TINYMCE_URI . '/tinymce-menu.js';
		return $plugin_array;
	}
