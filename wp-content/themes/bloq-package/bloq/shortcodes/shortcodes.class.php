			...
			foreach( $this->params as $pkey => $param )
			{
				...
				{	
					...
					case 'file' :
						...
						// prepare
						$output  = $row_start;
						@$output .= '<input type="text" class="vision-form-text vision-input" name="' . $pkey . '" id="' . $pkey . '" value="' . $param['std'] . '" />' . "\n" . '<input type="button" name="' . $pkey . '_button" class="button" id="' . $pkey . '_button" value="Browse" />' . "\n";
						$output .= $row_end;
				...
				foreach( $this->cparams as $cpkey => $cparam )
				{
					...
					switch( $cparam['type'] )
					{
						...
						case 'file' :
							...
							// prepare
							$coutput  = $crow_start;
							$coutput .= '<input type="text" class="vision-form-text vision-input" name="' . $cpkey . '" id="' . $cpkey . '" value="' . $cparam['std'] . '" />' . "\n" . '<input type="button" name="' . $cpkey . '_button" class="button" id="' . $cpkey . '_button" value="Browse" />' . "\n";
							$coutput .= $crow_end;
